 ...
 * <ul>
 *   <li>{@link hu.bme.aut.gergelyszaz.bGL.impl.VariableReferenceImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableReferenceImpl extends ExpressionImpl implements VariableReference
{
  ...
  {
    return BGLPackage.Literals.VARIABLE_REFERENCE;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, BGLPackage.VARIABLE_REFERENCE__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(Variable newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BGLPackage.VARIABLE_REFERENCE__REF, oldRef, ref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BGLPackage.VARIABLE_REFERENCE__REF:
